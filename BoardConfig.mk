...
# Verified Boot
<<<<<<< PATCH SET (1a0cf2 Merge remote-tracking branch 'lineage/lineage-22.2' into sta)
STOCK_SECURITY_PATCH := 2025-06-05 # Latest stock update available
=======
STOCK_SECURITY_PATCH := 2025-07-05 # Latest stock update available
>>>>>>> BASE      (b0faa4 FP4: Bump rollback index to latest stock update)
